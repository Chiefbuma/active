...
async function buildTransactions(transactionRows: any[]): Promise<Transaction[]> {
  ...
  return transactionRows.map(t => ({
    ...t,
    total_till: parseFloat(t.total_till),
    target: parseFloat(t.target),
    fuel: parseFloat(t.fuel),
    operation: parseFloat(t.operation),
    cash_deposited_by_staff: parseFloat(t.cash_deposited_by_staff),
    amount_paid_to_the_till: parseFloat(t.amount_paid_to_the_till),
    offload: parseFloat(t.offload),
    salary: parseFloat(t.salary),
    operations_cost: parseFloat(t.operations_cost),
    net_banked: parseFloat(t.net_banked),
    deficit: parseFloat(t.deficit),
    performance: parseFloat(t.performance),
    fuel_revenue_ratio: parseFloat(t.fuel_revenue_ratio),
